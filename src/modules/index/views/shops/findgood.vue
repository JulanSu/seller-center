<template>
  <section  class="findgood">
    <!--工具条-->
    <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
      <router-link to="/store/classify_management/allgood" class="allgood">关联其他商品</router-link>
    </el-col>
    ...
    <el-table :data="users" v-loading="listLoading" style="width: 100%;">
      ...
      <el-table-column prop="password" label="店内分类" min-width="190" align="center">
      </el-table-column>
      <el-table-column label="操作" min-width="200" align="center">
        <template scope="scope">
          <span @click="handleDel(scope.$index, scope.row)">移除</span>
        </template>
      </el-table-column>
    </el-table>
